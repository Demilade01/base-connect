      ...
      <AnimatePresence mode="wait">
        {isConnected ? (
          <motion.div
            ...
            className="space-y-4"
          >
            <div className="bg-gradient-to-br from-success/10 to-success/5 dark:from-success/20 dark:to-success/10 border border-success/20 dark:border-success/30 rounded-2xl p-8 max-w-md mx-auto shadow-lg">
              <motion.div
              ...
              >
                ...
                <div className="bg-white/50 dark:bg-neutral-800/50 rounded-lg p-3 mb-4">
            ...
            <AnimatePresence>
              {error && (
                <motion.div
                  ...
                  className="bg-error/10 dark:bg-error/20 border border-error/20 dark:border-error/30 rounded-xl p-4 max-w-md mx-auto"
                >
